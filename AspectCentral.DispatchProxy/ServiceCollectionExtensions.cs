...
public static class ServiceCollectionExtensions
{
    ...
    ///         <item>
    ///             <description>
    ///             Registers a singleton <see cref="InMemoryAspectConfigurationProvider" /> as
    ///             <see cref="IAspectConfigurationProvider" /> if one is not already registered.
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///             Reflectively scans every assembly currently loaded in <see cref="AppDomain.CurrentDomain" />
    ///             for concrete <see cref="IAspectFactory" /> implementations and registers each as a singleton against itself
    ///             (idempotent via <c>TryAddSingleton</c>).
    ///             </description>
    ///         </item>
    ///     </list>
    ///     </para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>ServiceType</c> is an interface and is closed (no open generic parameters).</description>
    ///         </item>
    ///         <item>
    ///             <description>Descriptor is non-keyed.</description>
    ///         </item>
    ///         <item>
    ///             <description><c>ImplementationType</c> is non-null (i.e. not an instance or factory descriptor).</description>
    ///         </item>
    ///     </list>
    ///     </para>
    ///     <para>
    ...
    /// <summary>
    /// Builds and executes the aspect chain factory for a service descriptor that uses a concrete
    /// implementation type.
    /// </summary>
    ...
    /// Thrown by dependency injection when the concrete implementation or any configured aspect
...
#pragma warning restore S1144 // Unused private types or members should be removed
    ...
    /// <summary>
    /// Closes the generic <c>CreateFactory&lt;TService&gt;</c> method for the configured service type
    /// and invokes it.
    /// </summary>
    /// <param name="serviceProvider">
    /// Service provider resolving the proxied service instance.
    /// </param>
    /// <param name="aspectConfiguration">
    /// Aspect configuration that identifies the service type and aspect chain.
    /// </param>
    /// <returns>
    /// A proxied service instance with all configured aspects applied.
    /// </returns>
    ...
    {
        return serviceCollection.RegisterAspectFactories(AppDomain.CurrentDomain.GetAssemblies());
    }
