...
///     </para>
/// </remarks>
/// <param name="loggerFactory">Used by the produced aspect to obtain a categorized <see cref="Microsoft.Extensions.Logging.ILogger"/>.</param>
...
public abstract class BaseAspectFactory(ILoggerFactory loggerFactory, IAspectConfigurationProvider aspectConfigurationProvider) : IAspectFactory
{
    /// <summary>
    ///     The <see cref="ILoggerFactory"/> used by produced aspects to create a categorized logger
    ...
    /// <summary>
    ///     The <see cref="IAspectConfigurationProvider"/> the produced aspect consults on every
    ///     intercepted call to decide whether <c>PreInvoke</c>/<c>PostInvoke</c> hooks should run.
    /// </summary>
    protected readonly IAspectConfigurationProvider AspectConfigurationProvider = aspectConfigurationProvider ?? throw new ArgumentNullException(nameof(aspectConfigurationProvider));
