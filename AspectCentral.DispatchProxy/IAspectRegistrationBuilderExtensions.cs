...
public static class IAspectRegistrationBuilderExtensions
{
    ...
    /// Thrown when <paramref name="aspectRegistrationBuilder" /> is
    /// <see langword="null" />.
    /// </exception>
    public static IAspectRegistrationBuilder AddAspectViaFactory<T>(
        this IAspectRegistrationBuilder aspectRegistrationBuilder, int? sortOrder = null,
